...
MOE <- pa_clean %>%
  mutate(
    # Calculate MOE as percentage of estimate
     moe = round((median_household_incomeM / median_household_incomeE) , 2),
...
selected_data <- select(top_5_cont, NAME, median_household_incomeM, moe, moe_percentage, reliability)
View(selected_data)
head(selected_data)

kable(selected_data,
      col.names = c("NAME", "median_household_incomeM", "moe", "moe_percentage", "moe"),
